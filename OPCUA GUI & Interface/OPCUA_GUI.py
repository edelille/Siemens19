...
class OPCUA_GUI():
    def __init__(self):
        ...
        #self.mainControlButtons.append(QPushButton("example function"))
    ...
    def tryConnect(self):
        try:
            ...
            #example connect
            self.mainControlButtons[9].toggled.connect(self.examplefunction)
